...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth,keepaspectratio]{Images/CryptoNote/normal_sig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth,keepaspectratio]{Images/CryptoNote/ring_sig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth,keepaspectratio]{Images/CryptoNote/result.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\columnwidth,keepaspectratio]{Images/CryptoNote/linkable_cropped.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\columnwidth,keepaspectratio]{Images/CryptoNote/unlinkable_cropped.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.74\columnwidth,keepaspectratio]{Images/CryptoNote/double_spending_cropped.pdf}
