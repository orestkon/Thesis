...
An example is presented in the \hyperref[sec:construction]{Appendix} of this thesis. There, the reader can find a real world construction of a Monero stealth address.%%% correct This
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
